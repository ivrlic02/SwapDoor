...
export function ExploreView({
  ...
  useEffect(() => {
    setDock(<FilterControls {...controls} />, activeFilterCount);
    return () => setDock(null, 0);
  }, [setDock, controls, activeFilterCount]);
...
function FilterControls({
  ...
  return (
    <div>
      ...
      <div className="mt-4 rounded-2xl border border-border bg-surface px-4 py-3 md:px-5">
        <label
          htmlFor={budgetId}
